...
const MENU_ITEMS: MenuItemTypes[] = [
  ...
  },
  {
    ...
    children: [
      {
        key: "ecommerce-invoicing",
        label: "Invoicing",
        role: ["admin",'manager','superadmin'],
        url: "/apps/finances/invoicing/1",
        parentKey: "apps-ecommerce",
      },
      {
        key: "ecommerce-water-utilities",
        label: "Water & Utilities",
        role: ["all"],
        url: "/apps/finances/water-utilities/1",
        parentKey: "apps-ecommerce",
      },
      {
        key: "ecommerce-receipts",
        label: "Receipts",
        role: ["all"],
        url: "/apps/finances/receipts/1",
        parentKey: "apps-ecommerce",
      },
      {
        key: "ecommerce-reminders",
        label: "Reminders",
        role: ["all"],
        url: "/apps/finances/reminders/1",
        parentKey: "apps-ecommerce",
      },
      {
