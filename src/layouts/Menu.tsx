...
const MenuItemWithChildren = ({
  ...
  return (<>
    {(item?.role?.includes(role || "") || item?.role?.includes("all"))&&<li className={classNames("menu-item", { "menuitem-active": open })}>
      <Link
        to="#"
            ...
            {(item.children || []).map((child, i) => {
              return (
                <React.Fragment key={i}>
                  {child.children ? (child?.role?.includes(role  || "") || child?.role?.includes("all"))&& (
                    <>
                      {/* parent */}
                  ...
                  ) :(child?.role?.includes(role || "") || child?.role?.includes("all"))&& (
                    <>
                      {/* child */}
                      <MenuItem
                        item={child}
        ...
        {(menuItems || []).map((item, idx) => {
          ...
          return (
            <React.Fragment key={idx}>
              {item.isTitle ? (item?.role?.includes(Role) || item?.role?.includes("all"))&&  (
                <li
                ...
                <>
                  {item.children ? (
                    <MenuItemWithChildren
                      ...
                      role={Role}
                    />
                  ) :(item?.role?.includes(Role) || item?.role?.includes("all"))&& (
                    <MenuItem
                      item={item}
                      linkClassName="menu-link"
                      className={
